...
* Make gazebo_ros_control compatible with ros_control with respect to <hardwareInterface> tag (`#550 <https://github.com/locusrobotics/gazebo_ros_pkgs/issues/550>`_)
